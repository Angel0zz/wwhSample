...
<body>
    <div id="navbar">
        ...
        <section>
            ...
            <a href="/pages/promo.html">Promos</a>
    ...
    <div class="main-bg" id="main-bg">
        ...
        <div>
            <form id="bookingForm" >
                <div class="title" style="font-size: 30px; font-style: italic;">Hospitality throught prism</div>
                <section>
                    <label id="checkin-checkout-label">Check-in - Check-out</label><br>
                    <input type="Text" id="checkin-checkout"  readonly value="Check-in - Check-out">
                    
                    
                    <div id="date-picker-modal" class="modal">
                        <div class="modal-header">Check-in Date</div>
                        <input type="date" id="checkInDate" name="checkin-date" required>

                        <div class="modal-header">Check-out Date</div>
                        <input type="date" id="checkOutDate" name="checkout-date" req>
                    </div>
        ...
        <!--On screen nav-->
        <div class="main-nav-container" id="main-nav-container" style="z-index: 1000;">
